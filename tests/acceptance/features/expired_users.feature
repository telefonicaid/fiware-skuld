Feature: Get the list of expired users from the IdM.
    ...
    Scenario: 01: Get the list of expired trial users
      Given an expired user with name "qa11", password "new2" and role "trial"
    ...
    Scenario: 02: Get the list of expired community users
      Given an expired user with name "qa11", password "new2" and role "community"
     ...
     Scenario: 03: several
      Given an expired user with name "qatrial11", password "new2" and role "trial"
